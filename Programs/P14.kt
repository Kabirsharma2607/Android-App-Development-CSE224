fun main(args:Array<String>)
{
    ...
    /* B. To create an empty string,create an instance of
    ...
    println(listOf('a','b','c').joinToString(".","(",")"))  // val separator:CharSequence="";val prefix:CharSequence="("; val postfix:CharSequence =")"})
    //when only one arg is passed and rest default are taken
    println(listOf('a','b','c').joinToString(".", postfix = "|") ) // val separator:CharSequence="";val prefix:CharSequence="("; val postfix:CharSequence =")"})
